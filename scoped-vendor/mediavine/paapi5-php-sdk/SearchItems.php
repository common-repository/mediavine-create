...
use Mediavine\Create\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\SearchItemsRequest;
use Mediavine\Create\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\SearchItemsResource;
use Mediavine\Create\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\PartnerType;
use Mediavine\Create\Amazon\ProductAdvertisingAPI\v1\com\amazon\paapi5\v1\ProductAdvertisingAPIClientException;
...
function searchItems()
{
     ...
     */
    $resources = array(SearchItemsResource::ITEM_INFOTITLE, SearchItemsResource::OFFERSLISTINGSPRICE);
    # Forming the request
    ...
    try {
        ...
        if ($searchItemsResponse->getSearchResult() != null) {
            ...
            if ($item != null) {
                ...
                if ($item->getItemInfo() != null and $item->getItemInfo()->getTitle() != null and $item->getItemInfo()->getTitle()->getDisplayValue() != null) {
                    echo "Title: ", $item->getItemInfo()->getTitle()->getDisplayValue(), \PHP_EOL;
                }
                if ($item->getOffers() != null and $item->getOffers() != null and $item->getOffers()->getListings() != null and $item->getOffers()->getListings()[0]->getPrice() != null and $item->getOffers()->getListings()[0]->getPrice()->getDisplayAmount() != null) {

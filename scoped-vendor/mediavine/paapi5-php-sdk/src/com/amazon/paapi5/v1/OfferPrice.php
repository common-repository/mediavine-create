...
class OfferPrice implements ModelInterface, ArrayAccess
{
     ...
     * @var string[]
     */
    protected static $swaggerTypes = ['amount' => 'float', 'currency' => 'string', 'displayAmount' => 'string', 'pricePerUnit' => 'float', 'savings' => 'Mediavine\\Create\\Amazon\\ProductAdvertisingAPI\\v1\\com\\amazon\\paapi5\\v1\\OfferSavings'];
    /**
     * Array of property to format mappings. Used for (de)serialization
     *
     * @var string[]
     */
    protected static $swaggerFormats = ['amount' => null, 'currency' => null, 'displayAmount' => null, 'pricePerUnit' => null, 'savings' => null];
    /**
     * Array of property to type mappings. Used for (de)serialization
     *
     * @return array
     ...
     * @var string[]
     */
    protected static $attributeMap = ['amount' => 'Amount', 'currency' => 'Currency', 'displayAmount' => 'DisplayAmount', 'pricePerUnit' => 'PricePerUnit', 'savings' => 'Savings'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['amount' => 'setAmount', 'currency' => 'setCurrency', 'displayAmount' => 'setDisplayAmount', 'pricePerUnit' => 'setPricePerUnit', 'savings' => 'setSavings'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['amount' => 'getAmount', 'currency' => 'getCurrency', 'displayAmount' => 'getDisplayAmount', 'pricePerUnit' => 'getPricePerUnit', 'savings' => 'getSavings'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *

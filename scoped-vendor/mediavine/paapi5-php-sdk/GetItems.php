...
function getItems()
{
     ...
     */
    $resources = array(GetItemsResource::ITEM_INFOTITLE, GetItemsResource::OFFERSLISTINGSPRICE);
    # Forming the request
            ...
            if ($getItemsResponse->getItemsResult()->getItems() != null) {
                ...
                foreach ($itemIds as $itemId) {
                    ...
                    if ($item != null) {
                        ...
                        if ($item->getOffers() != null and $item->getOffers()->getListings() != null and $item->getOffers()->getListings()[0]->getPrice() != null and $item->getOffers()->getListings()[0]->getPrice()->getDisplayAmount() != null) {
